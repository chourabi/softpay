                    ...
                    <div id="content-wrapper" className="d-flex flex-column">
                        ...
                        <div id="content">
                            ...
                            <div className="container-fluid">
                                ...
                                <h1 className="h3 mb-4 text-gray-800">Ajouter un utilisateur</h1>
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <label>Nom</label>
                                                    <input type="text" className="form-control" onChange={(e) => { this.setState({ nom: e.target.value }) }} />
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <label>Prénom</label>
                                                    <input type="text"  className="form-control" onChange={(e) => { this.setState({ prenom: e.target.value }) }} />
                                                </div>
                                            </div>
